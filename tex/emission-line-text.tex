...
The degree of ionization of atoms is largely determined by their
...
\item Estimate the typical collisional excitation levels found in
    ...
    they to decay directly to the ground state. \todo{finish answer}
...
\item For an HII region with $n_H = 10$ cm$^{-3}$ and of size $s=10$ pc,
 ...
 \todo{does this make sense to calculate? does it show actually most
 of the photon capture is near the edge of the HII region, since the
 typical ionization fraction is higher?}
...
\begin{itemize}
\item \todo{Is there a simple way to calculate $\nu^{-3}$?}
