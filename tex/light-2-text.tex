...
\begin{enumerate}
\item Prove Wien's law
\item How does the spectrum of deuterium differ from that of hydrogen
\end{enumerate}

\section{Numerics and Data Exercises}

\begin{enumerate}
\item Balmer series in emission, absorption
\item Lyman-alpha
\item Dusty spectra of stars
\item Dusty spectra of galaxies
\item PAH emission
\item Brehmstrahlung
\item Synchrotron
\end{enumerate}
