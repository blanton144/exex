...
Electromagnetic radiation in astronomy is defined in terms of the {\it
  specific intensity} $I_\nu$, which is the flux of energy across a
surface from a particular direction, per unit area, per unit solid
angle, per unit time, per unit frequency. The specific intensity can
also be expressed per unit wavelength, and denoted in this case
$I_\lambda$. For example, units may be erg s$^{-1}$ cm$^{-2}$
Hz$^{-1}$ arcsec$^{-2}$ or erg s$^{-1}$ cm$^{-2}$ \AA$^{-1}$
arcsec$^{-2}$.  The term {\it surface brightness} is often also used
to denote the specific intensity.
