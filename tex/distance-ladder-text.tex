...
\item Allen Sandage used to use brightest galaxies in clusters as a
   ...
   cluster galaxies for massive clusters. Are they reasonable standard
   candles? Show a Hubble diagram assuming that they are and compare
   to a standard Planck cosmology.
\item \citet{clementini18a} public a catalog of RR Lyrae variables
   from Gaia DR2. 
\end{enumerate}
