...
A {\it flux} $f$ is a flux density integrated over some wavelength or
frequency range. We will see below how the flux is related to the
astronomical magnitude. \todo{CHECK THIS NOMENCLATURE}
